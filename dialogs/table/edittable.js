...
(function () {
    ...
    editTable.prototype = {
        init: function () {
            ...
            domUtils.on(fixedSize, "click", me.fixedValueHanler)
    ...
    dialog.onok = function () {
        ...
        fixedSize.checked ? editor.execCommand('adaptbyfixedwidth') : '';
