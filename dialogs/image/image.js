    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                duplicate: false,//true-图片可重复,false-不可重复 ,[默认值：undefined]-无重复图片
                ...
                //[2018-08-22 尹磊] 多图上传添加__RequestVerificationToken，预防CSRF攻击。
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        // 修改源码 2018.05.04 余昭，解决多图上传乱序的问题，涉及到的文件(image.js,attachment.js) 
                        //修改 _this.imageList.push(json); 改为 _this.imageList[$file.index()] = json;
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                // 修改源码 2018.05.04 余昭，解决多图上传乱序的问题，涉及到的文件(image.js,attachment.js)。
                // (添加data判断undefined, 避免上传失败或图片不规范导致数组出现undefined项)
                if (!data) {
                    continue;
                }
