...
(function(){
    ...
    function createPreviewVideo(url) {
        ...
        if (conUrl.indexOf(".swf") === -1) {
            $G("preview").innerHTML = '<video class="edui-upload-video  vjs-default-skin video-js" controls="" preload="none" width="420" height="280" src="/Upload/main/ContentManage/Article/Video/2018/02/01/201802011424119002.mp4" data-setup="{}">'
        ...
        '<embed class="previewVideo" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"' +
            ' src="' + conUrl + '"' +' width="420"  height="280" ' +
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                compress: false,
                //[2018-08-22 尹磊] 视频上传添加__RequestVerificationToken，预防CSRF攻击。
